...
-->
<!-- code_block_exemption: 本章保留较多树模型与基线对比示例，便于把结构、评估和 StatLab 收束串起来。 -->
...
![](images/decision_tree_depth_3.png)
*图 1：一棵深度为 3 的树，先看结构，再看规则。*
...
![](images/decision_tree_overfitting.png)
*图 2：过拟合的树长得更深、更碎，但不一定更会预测新样本。*
...
![](images/baseline_comparison_auc.png)
*图 3：基线对比图，重点不是最高分，而是提升量是否值得。*
