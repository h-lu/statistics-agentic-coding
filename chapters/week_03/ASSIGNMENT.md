...
|------|------|------|------|------|------|
| sex | missing_values | drop_rows | 缺失率低，类别变量不适合强行填补 | most_frequent / manual_review | 删除过多样本会影响代表性 |
```

**要求补充**：
- 清洗日志要把“问题、处理、理由、替代方案、风险”写清楚
- 清洗没有唯一正确答案，但要能复核
...
- 可以把日志模板固定成 `field / issue / action / reason / alternatives / risk`
