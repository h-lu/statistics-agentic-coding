...
### AI 协作练习：审查 AI 生成的数据卡（10 分，选做）

| 评分点 | 分值 | 说明 |
|--------|------|------|
| 区分数据事实 vs 来源事实 | 4 分 | 能明确指出哪些信息直接来自数据，哪些必须查来源文档或数据许可证 |
| 样本代表性判断 | 3 分 | 能说明这份样本能代表什么、不能代表什么，不把样本结论偷换成总体结论 |
| 不编造未知字段 | 2 分 | 对 `license_or_terms`、`collection_process`、`human_review_notes` 这类字段保留"待核实"而不是乱填 |
| 审查建议具体 | 1 分 | 至少给出 1 条可执行的修改建议 |

**扣分项**：
- 把来源事实写成数据事实，或反过来：扣 2 分
- 把样本性质说成总体结论：扣 2 分
- 直接编造许可证、收集过程等信息：该项 0 分
