...
- A vs E：p = 0.03 通过：显著
- B vs E：p = 0.04 通过：显著
- C vs E：p = 0.08 错误： 不显著
- D vs E：p = 0.06 错误： 不显著
- A vs B：p = 0.75 错误： 不显著
- A vs C：p = 0.45 错误： 不显著
- A vs D：p = 0.60 错误： 不显著
- B vs C：p = 0.55 错误： 不显著
- B vs D：p = 0.70 错误： 不显著
- C vs D：p = 0.65 错误： 不显著
...
|------|-----------|--------|-----------|------|
| A vs E | +2.3% | [-0.8%, 5.4%] | 0.18 | 错误： |
| B vs E | +2.0% | [-1.1%, 5.1%] | 0.28 | 错误： |
| C vs E | +1.5% | [-1.6%, 4.6%] | 0.52 | 错误： |
| D vs E | +1.7% | [-1.4%, 4.8%] | 0.38 | 错误： |
| 其他 | < 1.0% | - | > 0.50 | 错误： |
