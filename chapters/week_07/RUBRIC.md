...
| 评分项 | 分值 | 评分标准 |
|--------|------|----------|
| 三种方法实现 | 10 分 | 正确实现未校正、Bonferroni、FDR 三种方法；FDR 需体现 p 值排序与 BH 临界点 |
| 对比表格 | 8 分 | 表格清晰展示三种方法的拒绝数、校正后阈值/adjusted p 值差异 |
| 方法解释 | 5 分 | 解释 Bonferroni 和 FDR 的区别、最大满足前缀保留的直觉和适用场景 |
| 代码可运行 | 2 分 | 代码无语法错误 |
