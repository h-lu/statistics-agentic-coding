...
**任务**：选 3 张你生成的 EDA 图，把图表转成可检验的问题。

**要求**：
1. 提交 3 张图，每张图都要说明你看到了什么
2. 对每张图标注它属于哪一类：
   - 描述（Description）：只是描述现象
   - 推断（Inference）：在描述之外给出可能解释
   - 预测（Prediction）：提出后续可验证的问题
3. 把每张图改写成 1 个可检验问题
4. 说明为什么你会把它归到这个类别
...
- **图表**：[图名 / 路径]
- **观察**：[你看到了什么]
- **类别**：[Description / Inference / Prediction]
- **可检验问题**：[下一步要验证什么]
